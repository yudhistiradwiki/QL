...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.title('RL Q-learning. Kelompok 4 Alfatih')
    ...
    def build_environment(self):
        ...
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 2, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 7, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 11
        ...
        # Obstacle 13
        self.obstacle13 = self.canvas_widget.create_image(0, pixels * 7, anchor='nw', image=self.obstacle4_object)
        # Obstacle 14
        ...
        self.flag = self.canvas_widget.create_image(0, pixels * 8, anchor='nw', image=self.flag_object)
